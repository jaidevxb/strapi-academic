...
export interface ApiEventItemEventItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Event migrated from WordPress';
    displayName: 'Event';
  ...
  attributes: {
    ...
    legacyWpId: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'News/blog post migrated from WordPress';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Catch-all for WordPress content that doesn't fit a typed collection (Team/News/Events/Resources/Projects/Podcasts/Films)";
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPodcastEpisodePodcastEpisode
  ...
  attributes: {
    audioUrl: Schema.Attribute.Text;
    content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Research project migrated from WordPress';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    publishedDate: Schema.Attribute.DateTime;
    researchers: Schema.Attribute.JSON;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Publication/resource migrated from WordPress';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    openAccess: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    publishedDate: Schema.Attribute.DateTime;
    publisher: Schema.Attribute.String;
    resourceType: Schema.Attribute.Enumeration<
      ['Book', 'Journal article', 'Report', 'Policy brief', 'Dataset']
    > &
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Researcher / staff profile migrated from WordPress';
  ...
  attributes: {
    ...
    sortOrder: Schema.Attribute.Integer;
    subgroup: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
